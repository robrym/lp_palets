  ...
  js: {
    ...
    plugins: {
      ...
      datatables: {
        ...
        src: ['node_modules/datatables.net/js/**/*.js', 'node_modules/datatables.net/js/**/*.mjs'],
        dest: path.src.jsplugins + 'datatables/'
      },
      'datatables-bs5': {
        base: path.src.jsplugins + 'datatables-bs5/',
        src: ['node_modules/datatables.net-bs5/**/*.css', 'node_modules/datatables.net-bs5/**/*.js', 'node_modules/datatables.net-bs5/**/*.mjs'],
        dest: path.src.jsplugins + 'datatables-bs5/'
      },
      'datatables-responsive': {
        base: path.src.jsplugins + 'datatables-responsive/',
        src: ['node_modules/datatables.net-responsive/**/*.css', 'node_modules/datatables.net-responsive/**/*.js', 'node_modules/datatables.net-responsive/**/*.mjs'],
        dest: path.src.jsplugins + 'datatables-responsive/'
      },
      'datatables-responsive-bs5': {
        base: path.src.jsplugins + 'datatables-responsive-bs5/',
        src: ['node_modules/datatables.net-responsive-bs5/**/*.css', 'node_modules/datatables.net-responsive-bs5/**/*.js', 'node_modules/datatables.net-responsive-bs5/**/*.mjs'],
        dest: path.src.jsplugins + 'datatables-responsive-bs5/'
      },
      'datatables-buttons': {
        base: path.src.jsplugins + 'datatables-buttons/',
        src: ['node_modules/datatables.net-buttons/js/**/*.js', 'node_modules/datatables.net-buttons/js/**/*.mjs'],
        dest: path.src.jsplugins + 'datatables-buttons/'
      },
      'datatables-buttons-bs5': {
        base: path.src.jsplugins + 'datatables-buttons-bs5/',
        src: ['node_modules/datatables.net-buttons-bs5/**/*.css', 'node_modules/datatables.net-buttons-bs5/**/*.js', 'node_modules/datatables.net-buttons-bs5/**/*.mjs'],
...
function depUpdate(depName, depData) {
  deleteAsync(depData.base).then(() => {
    if (depData.min) {
      return gulp.src(depData.src, { encoding: false })
...
gulp.task('build-clean', () => {
  return deleteAsync(path.dir.build);
});
gulp.task('clean', gulp.series('build-clean'));

// Copy folders and files to build folder
gulp.task('build-copy', () => {
  return gulp.src(files.build.copy, { encoding: false, base: path.dir.src })
