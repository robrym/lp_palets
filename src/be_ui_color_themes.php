...
<div class="content">
    ...
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-default text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="default" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Default</div>
        </div>
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-elegance text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="<?php echo $cb->assets_folder; ?>/css/themes/elegance.min.css" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Elegance</div>
        </div>
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-pulse text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="<?php echo $cb->assets_folder; ?>/css/themes/pulse.min.css" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Pulse</div>
        </div>
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-flat text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="<?php echo $cb->assets_folder; ?>/css/themes/flat.min.css" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Flat</div>
        </div>
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-corporate text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="<?php echo $cb->assets_folder; ?>/css/themes/corporate.min.css" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Corporate</div>
        </div>
        <div class="col-6 col-md-6 col-xl-2">
          <a class="item item-circle bg-earth text-white-75 mx-auto mb-3" data-toggle="theme" data-theme="<?php echo $cb->assets_folder; ?>/css/themes/earth.min.css" href="javascript:void(0)">
            <i class="fa fa-paint-brush"></i>
          </a>
          <div class="fw-semibold">Earth</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-primary mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-default mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-elegance-lighter mx-auto mb-3"></div>
          <code>.bg-elegance-lighter</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-elegance-light mx-auto mb-3"></div>
          <code>.bg-elegance-light</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-elegance mx-auto mb-3"></div>
          <code>.bg-elegance</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-elegance mx-auto mb-3"></div>
          <code>.bg-gd-elegance</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-elegance-dark mx-auto mb-3"></div>
          <code>.bg-elegance-dark</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-elegance-darker mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-pulse-lighter mx-auto mb-3"></div>
          <code>.bg-pulse-lighter</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-pulse-light mx-auto mb-3"></div>
          <code>.bg-pulse-light</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-pulse mx-auto mb-3"></div>
          <code>.bg-pulse</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-pulse mx-auto mb-3"></div>
          <code>.bg-gd-pulse</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-pulse-dark mx-auto mb-3"></div>
          <code>.bg-pulse-dark</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-pulse-darker mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        ...
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-flat mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-corporate-lighter mx-auto mb-3"></div>
          <code>.bg-corporate-lighter</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-corporate-light mx-auto mb-3"></div>
          <code>.bg-corporate-light</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-corporate mx-auto mb-3"></div>
          <code>.bg-corporate</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-corporate mx-auto mb-3"></div>
          <code>.bg-gd-corporate</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-corporate-dark mx-auto mb-3"></div>
          <code>.bg-corporate-dark</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-corporate-darker mx-auto mb-3"></div>
  ...
  <div class="block block-rounded">
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-earth-lighter mx-auto mb-3"></div>
          <code>.bg-earth-lighter</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-earth-light mx-auto mb-3"></div>
          <code>.bg-earth-light</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-earth mx-auto mb-3"></div>
          <code>.bg-earth</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-gd-earth mx-auto mb-3"></div>
          <code>.bg-gd-earth</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-earth-dark mx-auto mb-3"></div>
          <code>.bg-earth-dark</code>
        </div>
        <div class="col-6 col-md-4 col-xl-2">
          <div class="item item-circle bg-earth-darker mx-auto mb-3"></div>
    ...
    <div class="block-content">
      <div class="row items-push text-center">
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-dusk mx-auto mb-3"></div>
          <code>.bg-gd-dusk</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-cherry mx-auto mb-3"></div>
          <code>.bg-gd-cherry</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-aqua mx-auto mb-3"></div>
          <code>.bg-gd-aqua</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-emerald mx-auto mb-3"></div>
          <code>.bg-gd-emerald</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-sea mx-auto mb-3"></div>
          <code>.bg-gd-sea</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-leaf mx-auto mb-3"></div>
          <code>.bg-gd-leaf</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-lake mx-auto mb-3"></div>
          <code>.bg-gd-lake</code>
        </div>
        <div class="col-12 col-sm-6 col-md-3">
          <div class="item item-2x item-circle bg-gd-sun mx-auto mb-3"></div>
          <code>.bg-gd-sun</code>
        </div>
      </div>
    </div>
