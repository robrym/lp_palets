    ...
    <div class="content content-full">
      <div class="row g-6 w-100 py-7 overflow-hidden">
        <div class="col-md-6 order-md-last py-4 px-0 d-md-flex align-items-md-center justify-content-md-end">
          <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-hero.png" alt="Hero Promo">
        </div>
        <div class="col-md-6 py-4 d-flex align-items-center">
          <div class="text-center text-md-start">
            <h1 class="fw-black mb-3">
              Next generation UI framework for web apps
            </h1>
            ...
            <a class="btn btn-primary py-2 px-3" href="be_pages_dashboard.php" target="_blank">
              Live Preview
    ...
    <div class="pt-7 pb-5">
      ...
      <div class="row g-5 py-2">
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="be_pages_dashboard.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_classic.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_clean.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_social.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_corporate.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_minimal.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_pop.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="db_medical.php" target="_blank">
        ...
        <div class="col-md-4 py-2">
          <a class="options-container push text-white rounded overflow-hidden" href="be_pages_dashboard2.php" target="_blank">
            <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/preview-db-dashboard2.png" alt="Dashboard Media">
            <div class="options-overlay bg-black-50">
              <div class="options-overlay-content h5 fw-bold text-uppercase">
                <i class="fa fa-link fa-2x"></i>
              </div>
      ...
      <div class="text-center">
        <a class="btn btn-alt-secondary py-3 px-4" href="be_pages_dashboard4.php" target="_blank">
  ...
  <div class="position-relative">
    <div class="content content-full">
      <div class="pt-7 pb-5">
        ...
        <div class="row g-5 py-2">
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_crypto_dashboard.php" target="_blank">
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_ecom_dashboard.php" target="_blank">
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_elearning_courses.php" target="_blank">
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_forum_categories.php" target="_blank">
          ...
          <div class="col-md-4 py-2">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_auth_all.php" target="_blank">
          ...
          <div class="col-md-4 py-3">
            <a class="options-container push text-white rounded overflow-hidden" href="be_pages_error_all.php" target="_blank">
        ...
        <div class="text-center">
          <a class="btn btn-alt-secondary py-3 px-4" href="be_pages_generic_todo.php" target="_blank">
...
<div class="bg-body-extra-light">
  <div class="content">
    ...
    <div class="row g-0 pull-b text-center overflow-hidden">
      <div class="col-4">
        <a class="options-container" href="be_pages_dashboard.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-layout-backend.png" alt="Backend Promo">
      ...
      <div class="col-4">
        <a class="options-container" href="db_classic.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-layout-classic-dashboard.png" alt="Classic Dashboard Promo">
          <div class="options-overlay bg-body-extra-light">
            <div class="options-overlay-content">
              <h3 class="h5 fw-bold text-uppercase mb-1">
      ...
      <div class="col-4">
        <a class="options-container" href="be_layout_api.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-layout-api.png" alt="Layout API Promo">
          <div class="options-overlay bg-body-extra-light">
            <div class="options-overlay-content">
              <h3 class="h5 fw-bold text-uppercase mb-1">
...
<div class="bg-body-light">
  <div class="content content-full">
    ...
    <div class="row g-0 pull-b text-center overflow-hidden">
      <div class="col-4">
        <a class="options-container" href="be_ui_grid.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-bootstrap-grid.png" alt="Bootstrap 5 Grid Promo">
      ...
      <div class="col-4">
        <a class="options-container" href="be_ui_typography.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-bootstrap-typography.png" alt="Bootstrap 5 Typography Promo">
          <div class="options-overlay bg-body-light">
            <div class="options-overlay-content">
              <h3 class="h5 fw-bold text-uppercase mb-1">
      ...
      <div class="col-4">
        <a class="options-container" href="be_ui_buttons.php" target="_blank">
          <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-bootstrap-buttons.png" alt="Bootstrap 5 Buttons Promo">
          <div class="options-overlay bg-body-light">
            <div class="options-overlay-content">
              <h3 class="h5 fw-bold text-uppercase mb-1">
...
<div class="bg-body-extra-light">
  <div class="content content-full">
    ...
    <div class="row g-0 justify-content-center pull-b text-center overflow-hidden">
      <div class="col-sm-6">
        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-smart-tools.png" alt="Smart Tools Promo">
      </div>
    </div>
  </div>
</div>
...
<div class="bg-body-light">
  <div class="content content-full">
    ...
    <div class="row g-0 pull-b text-center overflow-hidden">
      <div class="col-4">
        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-developer-minded-php.png" alt="Developer Minded PHP Promo">
      </div>
      <div class="col-4">
        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-developer-minded-docs.png" alt="Developer Minded Docs Promo">
      </div>
      <div class="col-4">
        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/media/various/landing-promo-developer-minded-html.png" alt="Developer Minded HTML Promo">
      </div>
    </div>
  </div>
</div>
      ...
      <div class="pt-7 pb-5">
        ...
        <div class="row g-4 py-2">
          ...
          <div class="col-md-4 py-3 text-center text-md-start">
            ...
            <a class="btn btn-alt-secondary" href="be_pages_dashboard.php" target="_blank">
