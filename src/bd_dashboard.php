...
<div class="content">
  ...
  <div class="row">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-rotate text-center" href="be_pages_generic_inbox.php">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-rotate text-center" href="be_pages_generic_profile.php">
        <div class="block-content">
          <p class="my-3">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-rotate text-center" href="be_pages_forum_categories.php">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-rotate text-center" href="be_pages_generic_search.php">
        <div class="block-content">
          <p class="my-3">
    ...
    <div class="col-6 col-md-4 col-xl-2">
      <a class="block block-rounded block-link-rotate text-center" href="be_comp_charts.php">
        <div class="block-content">
          <p class="my-3">
