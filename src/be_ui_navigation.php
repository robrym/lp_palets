      ...
      <div class="block block-rounded h-100 mb-0">
        ...
        <div class="block-content">
          <nav class="d-flex justify-content-between align-items-center push">
            <button type="button" class="btn btn-alt-secondary" data-bs-toggle="tooltip" title="Previous">
              <i class="fa fa-angle-left fa-fw"></i>
            </button>
            <button type="button" class="btn btn-alt-secondary" data-bs-toggle="tooltip" title="Next">
          ...
          <nav class="d-flex justify-content-between align-items-center push">
            <button type="button" class="btn btn-alt-secondary">Next</button>
            <button type="button" class="btn btn-alt-secondary">Previous</button>
          </nav>
        </div>
      </div>
      <!-- END Pager -->
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content">
          <ul class="nav nav-pills space-x-1 push">
            ...
            <li class="nav-item">
              <a class="nav-link" href="javascript:void(0)">
                Profile <span class="badge rounded-pill bg-black-50 ms-1">1</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="javascript:void(0)">
