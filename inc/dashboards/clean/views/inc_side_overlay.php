<?php
/**
 * dashboards/clean/views/inc_side_overlay.php
 *
 * Author: pixelcave
 *
...
<aside id="side-overlay">
  ...
  <div class="content-header bg-primary-dark">
    ...
    <a class="img-link me-2" href="be_pages_generic_profile.php">
      <?php $cb->get_avatar(11, '', 32); ?>
    </a>
    <!-- END User Avatar -->

    <!-- User Info -->
    <a class="link-fx text-white fw-semibold fs-sm" href="be_pages_generic_profile.php">
      Admin
    </a>
    <!-- END User Info -->
  ...
  <div class="content-side">
    ...
    <div class="block pull-x">
      <div class="block-content block-content-full bg-danger-light">
        ...
        <div class="progress mb-0" style="height: 5px;" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100">
