...
<header id="page-header">
  ...
  <div class="content-header">
    ...
    <div class="space-x-1">
      ...
      <!-- Full Search -->
      <form class="d-none d-sm-inline-block" action="db_pop.php" method="POST">
      ...
      <button type="button" class="btn btn-sm btn-alt-secondary" data-toggle="layout" data-action="side_overlay_toggle">
        <i class="fa fa-cog"></i>
        <i class="fa fa-fa-circle-notch text-danger"></i>
        <span class="text-primary text-danger">&bull;</span>
      </button>
