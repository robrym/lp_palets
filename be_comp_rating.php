...
<div class="content">
  ...
  <!-- Rating functionality is initialized in js/pages/be_comp_rating.min.js which was auto compiled from _js/pages/be_comp_rating.js -->
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content block-content-full">
          <div class="row">
            <div class="col-md-6">
              Current Hint: <span class="js-rating-hint-text fw-semibold">..</span>
            </div>
            <div class="col-md-6">
              <!-- Rating Container -->
    ...
    <div class="col-lg-12">
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content">
          <div class="row items-push-2x">
            <div class="col-md-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="si si-drop text-earth" data-star-off="si si-drop text-muted opacity-50"></div>
            </div>
            <div class="col-md-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="fa fa-fw fa-coffee text-info" data-star-off="fa fa-fw fa-thumbs-up text-muted opacity-50"></div>
            </div>
            <div class="col-md-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="fa fa-fw fa-check text-primary" data-star-off="fa fa-fw fa-check text-muted opacity-50"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="block block-rounded">
        ...
        <div class="block-content">
          <div class="row items-push-2x text-center text-xl-start">
            <div class="col-xl-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="fa fa-fw fa-2x fa-heart text-pulse" data-star-off="fa fa-fw fa-2x fa-heart text-muted opacity-50"></div>
            </div>
            <div class="col-xl-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="fa fa-fw fa-2x fa-star text-warning" data-star-off="fa fa-fw fa-2x fa-star text-muted opacity-50"></div>
            </div>
            <div class="col-xl-4">
              <!-- Rating Container -->
              <div class="js-rating" data-score="3" data-star-on="fa fa-fw fa-2x fa-bolt text-flat" data-star-off="fa fa-fw fa-2x fa-bolt text-muted opacity-50"></div>
            </div>
          </div>
        </div>
      </div>
...
<!-- Page JS Plugins -->
<?php $cb->get_js('js/plugins/raty-js/jquery.raty.js'); ?>
